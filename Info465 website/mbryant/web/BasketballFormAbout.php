...
<h1>About the PHP, JavaScript, HTML, &amp; CSS</h1>
 <ul class=\"FinePrint\">
  ...
  the resource, BasketballForm.php, as specified in the form's action property.  
  ...
  head of the document. Find the function ValidateForm() in the file BasketballValidateForm.js 
  ...
  <li>The server-side script is available at /home/mylogin/web/BasketballForm.php.  </li>
  ...
  <li>From the command line find the function  MakeTheForm() at the beginning or BasketballForm.php. 
  ...
  <li>Never use or allow spaces in 
    ...
    space from names of Basketball teams like La Lakers or Golden State Warriors when making ids</li> 
  ...
  The properties of FavoriteBasketballTeam 
        are loaded by reading text files off the web directory at /home/mylogin/NbaTeams.txt and teams. 
  ...
  used to receive post data in the PHP script.  In the HTML, note that FavoriteBasketbalTeam[]
  ...
  <li>The Form's onSubmit event calls the JavaScript function ValidateForm().
         ...
         to the script specified in the form's method, in this case BasketballForm.php.</li>
