...
if (!isset($_REQUEST["View"])) {
  ...
  header("Location: BasketballController.php");
  exit;
} 
...
if ($View == "ByRegion") {
  ...
  $Report .= "       </table><br /><br />\n      </div>\n\n";
    ...
    $Report .= "\n\n\n<form method=POST action=\"BasketballPoPReports.php\" >\n\n";
...
$ReportTemplate = file_get_contents('TemplateBasketballForm.html');
$ReportTemplate = str_replace('[[[LoginAdvice]]]', LoginAdvice(" | <a href=\"BasketballController.php\">Menu</a> "), $ReportTemplate);
